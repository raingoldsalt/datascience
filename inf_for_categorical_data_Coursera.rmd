...
af12 <- atheism %>% filter(nationality == "Afghanistan", year=="2012")
inference(y=response, data = af12, statistic = "proportion", 
          method = "theoretical", type="ci", success = "atheist")
ar12 <- atheism %>% filter(nationality == "Argentina", year == "2012")
inference(y=response, data = ar12, type = "ci", method = "theoretical", 
          statistic = "proportion", success = "atheist")
```
...
inference(x=year, y=response, data = sp, type = "ht", method = "theoretical",
          statistic = "proportion", alternative = "twosided", success="atheist", null = 0)

#es <- subset(atheism, atheism$nationality == "Spain")
#inference(es$response, as.factor(es$year), data = es,
...
un <- atheism %>% filter(nationality=="United States")
inference(x=year, y=response, data = un, success="atheist",type = "ht", 
          method = "theoretical", alternative = "twosided", null=0, statistic = "proportion")
```
